...
This skill is adapted from [wondelai/skills](https://github.com/wondelai/skills) — [original source](https://github.com/wondelai/skills/tree/main/improve-retention) — distributed under MIT License. Original authors: Wondelai contributors. Content and structure preserved; frontmatter `name` shortened for integration with the `ui-excellence` plugin namespace.
